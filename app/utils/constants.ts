...
export const CREATE_CHECK_IN_SCANNER = "CREATE_CHECK_IN_SCANNER";
export const GET_GUEST_INFO_SCANNERS = "GET_GUEST_INFO_SCANNERS";
export const CHECK_IN_GUEST = "CHECK_IN_GUEST";
export const GET_USER_EVENT_CHECK = "GET_USER_EVENT_CHECK";