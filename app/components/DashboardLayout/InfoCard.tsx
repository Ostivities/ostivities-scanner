...
const InfoCard: React.FC<PropsI> = ({
  ...
  return (
    <Link
      href={url}
      className="relative w-full min-w-[260px] h-[350px] rounded-[30px] overflow-x-auto shadow-md"
    >
      ...
      <div className=" text-white">
        ...
        <div className="absolute bottom-0 left-0 px-5 py-5 flex flex-col items-center justify-center w-full">
          <h3
            className={`${titleClass} text-[18px] font-black text-center`}
          ...
          <div
            className={`flex flex-col gap-2 mt-2 ${aboutClass} items-center justify-center w-full`}
          >
